...
describe("Guess The New Number Challenge", function() {
    beforeEach(async function() {
        ...
        contract = await (await ethers.getContractFactory("GuessTheNewNumberChallenge")).deploy({value: ethers.utils.parseEther("1.0")});
        await contract.deployed();
        hacker = await (await ethers.getContractFactory("GuessTheNewNumberAttack")).deploy(contract.address);
